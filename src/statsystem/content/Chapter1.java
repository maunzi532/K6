	...
	public void createCharacters(LevelMap levelMap, Tile... locations)
	{
		if(locations.length > 0)
		{
			new Entity2Builder(levelMap)
					...
					.setStats(new Stats(XClasses.mageClass(), 0, new NameText("Anna"), "mapsprite.default",
		...
		if(locations.length > 1)
		{
			new Entity2Builder(levelMap)
					...
					.setStats(new Stats(XClasses.explorerClass(), 2, new NameText("Kate"), "mapsprite.default",
		...
		if(locations.length > 2)
		{
			new Entity2Builder(levelMap)
					...
					.setStats(new Stats(XClasses.squireClass(), 0, new NameText("John"), "mapsprite.default",
		...
		if(locations.length > 3)
		{
			new Entity2Builder(levelMap)
					...
					.setStats(new Stats(XClasses.hexerClass(), 4, new NameText("Selen"), "mapsprite.default",
		...
		if(locations.length > 4)
		{
			new Entity2Builder(levelMap)
					...
					.setStats(new Stats(XClasses.banditClass(), 10, new NameText("Dave"), "mapsprite.default",
		...
		if(locations.length > 5)
		{
			new Entity2Builder(levelMap)
					...
					.setStats(new Stats(XClasses.soldierClass(), 12, new NameText("Edna"), "mapsprite.default",
