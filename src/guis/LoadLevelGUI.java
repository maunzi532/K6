...
public class LoadLevelGUI extends GUIState
{
	private static final AreaTile savesText = new AreaTile(2, 0, new GuiTile("_Saves"), 2, 1);
	private static final AreaTile worldsText = new AreaTile(4, 0, new GuiTile("_Worlds"), 2, 1);
	...
	public void onEnter(MainState mainState)
	{
		...
		elements.add(worlds);
		elements.add(new TileElement(savesText));
		elements.add(new TileElement(worldsText));
		update();
	}
