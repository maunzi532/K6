...
public class SpellItem extends AttackItem2
{
	...
	{
		this(damage, heavy, slow, accuracy, crit, abilities, new int[]{1, 2, 3, 4}, new int[]{1, 2, 3, 4, 5, 6});
	}

	private SpellItem(int damage, int heavy, int slow, int accuracy, int crit, List<Ability2> abilities, int[] ranges,
			int[] counterR)
	{
