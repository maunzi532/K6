...
public class AttackItems2
{
	...
	public AttackItems2()
	{
		...
		items[400] = new AI2Builder(SpellItem.INSTANCE, 11, 17, 90).slow(4).adaptive(10, AdaptiveType.COST).build();
		items[401] = new AI2Builder(SpellItem.INSTANCE, 15, 19, 120).slow(6).adaptive(10, AdaptiveType.COST).build();
		items[402] = new AI2Builder(SpellItem.INSTANCE, 11, 12, 60).slow(2).adaptive(10, AdaptiveType.COST).build();
